...
module.exports.run = async (bot, message, args) => {
  ...
  if (args[0] == "help") {
    ...
    const meanEmbed = new Discord.RichEmbed()
      ...
      .setDescription("<:molecularLocked:508290171452653581> Error: ``Usage: $delrole <user> <role>``")
      .setTimestamp()
      .setColor("BLURPLE");
  ...
  .setTitle("Seems like you're missing a required argument:")
  .setDescription("<:molecularLocked:508290171452653581> Error: ``That user don't have that role!``")
  .setTimestamp()
  .setColor("BLURPLE");
  ...
  try{
    ...
    .setColor("BLURPLE")
    .addField(`<:molecularYes:508290171507310631> **DelRole Info**`, `Losted role: **${rMember}**
      Took by: **${message.author}**
      Role: **${gRole.name}**
    ...
    .setColor("BLURPLE")
    .addField(`<:molecularYes:508290171507310631> **DelRole Info**`, `You lost role in **${message.guild.name}**!
      Took by: **${message.author}**
      Role: **${gRole.name}**
      Time: **${moment.parseZone(message.author.createdAt).locale('en').format('DD/MM/YYYY, HH:mm')}**`)
